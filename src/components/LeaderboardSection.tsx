    ...
    <section id="leaderboard" className="py-16 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400">Top performers ranked by their highest mock test aggregate score.</p>
        </div>

        <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
          {/* Header */}
          <div className="flex items-center gap-3 px-5 py-4 border-b" style={{ borderColor: 'rgba(0,180,216,0.15)', background: 'rgba(0,180,216,0.05)' }}>
          ...
          {loading ? (
            ...
            <div className="py-16 text-center text-gray-400">
              ...
              <p className="text-sm">No scores yet. Be the first to crack the test!</p>
            </div>
          ) : (
            entries.map((entry, i) => (
              <div
                key={i}
                className="flex items-center gap-3 px-5 py-4 border-b transition-colors hover:bg-white/[0.02]"
              ...
              >
                ...
                <div className="text-right">
                  <span className="text-lg font-extrabold" style={{ color: 'var(--cyan)' }}>{formatScore(entry.highest_score)}</span>
